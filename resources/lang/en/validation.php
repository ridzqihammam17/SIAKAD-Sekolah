    ...
    */
    ...
    'custom' => [
        ...
        'nip' => [
            ...
            'string' => 'Kolom NIP harus berupa string.',
            'size' => 'Kolom NIP harus :size angka.',
        ...
        'nama_guru' => [
            'required' => 'Kolom NAMA GURU harus di isi.',
            'string' => 'Kolom NAMA GURU harus berupa string.',
            'max' => 'Kolom NAMA GURU tidak boleh lebih dari :max karakter.',
        ],

        'jenis_kelamin' => [
            'required' => 'Kolom JENIS KELAMIN harus di isi.',
            'in' => 'Kolom JENIS KELAMIN harus dipilih Laki atau Perempuan.',
        ],

        'tanggal_lahir' => [
            'required' => 'Kolom TANGGAL LAHIR harus di isi.',
            'date' => 'Kolom TANGGAL LAHIR harus harus di isi dengan format yang benar.',
        ],
        ...
        'id_ekskul' => [
            'required' => 'Kolom EKSKUL harus diisi',
        ],
        'id_pelajaran' => [
            'required' => 'Kolom PELAJARAN harus diisi',
        ],
        'alamat' => [
        ...
        'foto' => [
            ...
            'mimes' => 'Kolom FOTO hanya boleh diisi file *.jpeg, *.jpg *.png, *.bmp',
            'dimensions' => 'FOTO harus berukuran 150x150 pixel',
        ],
